...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter.initiateGetFollowersAndFollowingCount(selectedUser);
        ...
        followerCount.setText(getString(R.string.followerCount, String.valueOf(10000)));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.logoutMenu) {
            AuthToken authToken = Cache.getInstance().getCurrUserAuthToken();
            presenter.initiateLogout(authToken);
            return true;
        } else {
    ...
    public void onStatusPosted(String post) {
        ...
        try {
            presenter.initiatePostStatus(Cache.getInstance().getCurrUserAuthToken(), post, Cache.getInstance().getCurrUser());
        } catch (Exception ex) {
    ...
    @Override
    public void updateFollowAndUnfollow(boolean added) {
        presenter.initiateGetFollowersAndFollowingCount(selectedUser);
        updateIsFollower(added);
